...
! !DESCRIPTION:
!
! brom_cod parameterize  the Chemical Oxygen Demand, COD (https://en.wikipedia.org/wiki/Chemical_oxygen_demand) 
! OM mineralization, nitrification, and oxidation of reduced specied of S, Mn, Fe, present in suboxic conditions.
! brom_cod consists of 1 state variables ( in oxygen-units):
