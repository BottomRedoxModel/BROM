...
! Send rates of change to FABM.
       _SET_ODE_(self%id_mp_free, Decay_MP_free - free2biof + det2free - free2het + het2biof  )
       _SET_ODE_(self%id_mp_biof, Decay_MP_biof + free2biof - biof2het) ! + het2biof)
       _SET_ODE_(self%id_mp_het,  Decay_MP_het + free2het + biof2het - het2det - het2biof + det2het )
       _SET_ODE_(self%id_mp_det,  Decay_MP_det + het2det  - det2free - det2het)
...
>>>>>>> 54961af418f4872ea9a4aecf3cd8d1f69272d66a
end module