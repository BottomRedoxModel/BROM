...
!      _SET_DIAGNOSTIC_(self%id_fe_si_compl,fe_si_compl)
  ...
  !    Wtot = self%WFe + Wadd 
  !
  !    _ADD_VERTICAL_VELOCITY_(self%id_Fe3, Wtot)
  !    _ADD_VERTICAL_VELOCITY_(self%id_FeS, Wtot)
  !    _ADD_VERTICAL_VELOCITY_(self%id_FeCO3, Wtot)
  !    _ADD_VERTICAL_VELOCITY_(self%id_FeS2, Wtot)
  !    _ADD_VERTICAL_VELOCITY_(self%id_Fe3PO42, Wtot)
  !    _ADD_VERTICAL_VELOCITY_(self%id_PO4_Fe3, Wtot)
  !
  !   _LOOP_END_
  !
